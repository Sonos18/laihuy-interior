...
const transformMap = {
  up: (distance: string) => `translateY(${distance})`,
  down: (distance: string) => `translateY(-${distance})`,
  left: (distance: string) => `translateX(${distance})`,
  right: (distance: string) => `translateX(-${distance})`
}
