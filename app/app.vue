...
const description = 'Thiết kế nội thất hiện đại, sang trọng và đẳng cấp cho không gian sống của bạn. Chúng tôi mang lại giải pháp nội thất toàn diện từ tư vấn đến thi công.'
  ...
  <div class="min-h-screen flex flex-col bg-white">
    ...
    >
      <nav class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <!-- Mobile Menu Button -->
        <div class="md:hidden">
          <UButton icon="i-lucide-menu" color="brand-blue" variant="ghost" size="lg" />
        </div>
      </nav>
    </header>
    ...
    <footer class="bg-brand-blue-900 text-white py-16 px-6">
      <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-brand-blue-200 text-sm">
              <li><NuxtLink to="/" class="hover:text-orange-400 transition-colors">Trang chủ</NuxtLink></li>
              <li><NuxtLink to="/gioi-thieu" class="hover:text-orange-400 transition-colors">Về chúng tôi</NuxtLink></li>
              <li><NuxtLink to="/du-an" class="hover:text-orange-400 transition-colors">Dự án</NuxtLink></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div class="flex gap-4">
              <a href="#" class="text-brand-blue-200 hover:text-orange-400 transition-colors">
        ...
        <div class="border-t border-brand-blue-700 pt-8 text-center text-brand-blue-300 text-sm">
          <p>&copy; {{ new Date().getFullYear() }} Lai Huy Interior. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  </div>
