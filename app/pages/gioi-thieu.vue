      ...
      <div class="max-w-6xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p class="text-lg text-gray-600 mb-4 leading-relaxed">
              Qua những năm, chúng tôi đã phát triển thành một công ty hàng đầu
              với đội ngũ thiết kế chuyên nghiệp, kiến trúc sư tài năng và thợ
              thủ công lành nghề.
            </p>
            <p class="text-lg text-gray-600 leading-relaxed">
              Hôm nay, Lai Huy tự hào là người bạn đáng tin cậy của hàng nghìn
              gia đình và doanh nghiệp trong việc tạo nên những không gian sống
              và làm việc tuyệt vời.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white p-8 rounded-2xl shadow-md">
            ...
            <p class="text-gray-600">
              Chúng tôi yêu thích từng chi tiết, từ đó tạo nên những không gian
              hoàn hảo
            </p>
          </div>
