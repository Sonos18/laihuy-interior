...
<template>
  <div>
    <!-- Hero Image Gallery -->
    <section class="relative h-96 md:h-screen overflow-hidden group">
      <img
      ...
      <!-- Image Counter -->
      <div
        class="absolute bottom-6 right-6 bg-black/50 text-white px-4 py-2 rounded-full text-sm"
      >
              ...
              <ul class="space-y-3">
                ...
                >
                  <Icon
                    ...
                    class="w-6 h-6 text-orange-500 flex-shrink-0 mt-0.5"
                  />
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6 bg-white">
              <p class="text-orange-500 font-semibold mb-2 text-sm">Căn Hộ</p>
          ...
          >
            ...
            <div class="p-6 bg-white">
              <p class="text-orange-500 font-semibold mb-2 text-sm">Biệt Thự</p>
              <h3 class="text-xl font-bold text-slate-900">
                Biệt Thự Hạng Sang
              </h3>
            </div>
